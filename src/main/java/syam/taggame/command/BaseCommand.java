...
import syam.taggame.ConfigurationManager;
...
public abstract class BaseCommand {
	// Logger
	protected static final Logger log = TagGame.log;
	protected static final String logPrefix = TagGame.logPrefix;
	protected static final String msgPrefix = TagGame.msgPrefix;
	/* コマンド関係 */
	...
	protected TagGame plugin;
	protected ConfigurationManager config;

	public boolean run(final TagGame plugin, final CommandSender sender, final String[] preArgs, final String cmd) {
		this.plugin = plugin;
